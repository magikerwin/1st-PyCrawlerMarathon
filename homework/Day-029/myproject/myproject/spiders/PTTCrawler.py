...
class PttcrawlerSpider(scrapy.Spider):
    ...
    def __init__(self, boards_txt_path):
        # get target boards list
        boards = []
        with open(boards_txt_path, 'r') as f:
            for line in f.readlines():
                boards.append(line.replace("\n",""))

        self.cookies = {'over18': '1'}
        self.host = 'https://www.ptt.cc'
        self.start_urls = ['https://www.ptt.cc/bbs/{}/index.html'.format(board) for board in boards]
        super().__init__()
