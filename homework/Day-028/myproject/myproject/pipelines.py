...
class JSONPipeline(object):
    ...
    def close_spider(self, spider):
        ...
        if spider.name == 'PTTCrawler' and spider.output_path:
            if Path(spider.output_path).suffix == '.json':
                self.store_file_path = self.dir_path / spider.output_path
            else:
                self.store_file_path = self.dir_path / '{}.json'.format(spider.output_path)
